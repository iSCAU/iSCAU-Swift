...
@objc public class CoreDataManager {
    
    private let storeName = "iSCAUSwift"
    private let storeSqliteName = "iSCAUSwift.sqlite"

    @objc public class var sharedInstance: CoreDataManager {
    ...
    @objc lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "AlvinZhu.CoreDataDemo" in the application's documents Application Support directory.
    ...
    @objc lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent(self.storeSqliteName)
        ...
        if coordinator!.addPersistentStoreWithType(NSSQLiteStoreType, configuration: nil, URL: url, options: nil, error: &error) == nil {
            ...
            error = NSError(domain: "com.iSCAU.iSCAU", code: 9999, userInfo: dict)
