    ...
    switch (model.style) {
        ...
        case CellDayTypePast://过去的日期
            ...
            if (model.holiday) {
                ...
                day_lab.text = [NSString stringWithFormat:@""SINT"",model.day];
            }
        ...
        case CellDayTypeClick://被点击的日期
            ...
            day_title.text = model.Chinese_calendar;
            imgview.image = [imgview.image rt_tintedImageWithColor:OrangeColor];
            imgview.hidden = NO;
            
            break;
        case CellDayTypeNotice:
            [self hidden_NO];
            if (model.holiday) {
                day_lab.text = model.holiday;
                day_lab.textColor = COLOR_THEME_NOTICE;
            }else{
                day_lab.text = [NSString stringWithFormat:@""SINT"",model.day];
                day_lab.textColor = COLOR_THEME_NOTICE;
            }
